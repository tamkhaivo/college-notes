...
variance. Overfitting is the enemy; regularization (L1/L2, dropout) is essential but must
...
• Core Algorithms & Mechanisms:
• Q-Learning: Value-based, uses Bellman equation ( Q(s,a) = r + \gamma \max\_{a'} Q(s',a')
